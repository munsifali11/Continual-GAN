...
class Trainer(object):
    ...
    def generator_trainstep(self, y, z):
        ...
        #other than base task
        toggle_gradG(self.generator, True)
...
""" def toggle_gradG(model, requires_grad):
   ...
   #gf_paralist_half=[1,2,5,6,7,8,15,16,17,18,25,26,27,28,37,38,39,40,49,50,51,52,61,62,63,64,73,74,75,76,9,10,13,19,20,23,29,30,33,41,42,45,53,54,57,65,66,69,77,78,81]
   #gf_paralist_half=[1,2,5,6,7,8,15,16,17,18,25,26,27,28,37,38,39,40,49,50,51,52,61,62,63,64,73,74,75,76,9,10,13,19,20,23,29,30,33,41,42,45,53,54,57]
   if requires_grad:
       i=0
       for p in model.parameters():
           if i in gf_paralist:
